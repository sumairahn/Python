...
',,,,.     |         _.'''''''._
     ...
     |                                '',
      ',,-,                           ':;
           ...
           ;,,      !,!   !,!     ;,;
           /_I      L_I   L_I     /_I
Yay, our little camel is sunbathing!"""
       ...
       \   \     \        |      /
        \_, \    /        \     |\
          ...
          \  \  |           |  / \  |
           ...
           |_||_|           |_|   |_|
          /_//_/           /_/   /_/
Our friend looks hungry. Let's go to feed it!"""
...
Switching on camera from habitat with geese...
 ...
 <_  `     (  <`<            \              `-._\
  <`-       (__< <           :
   (__        (_<_<          ;
    `------------------------------------------
This bird is staring intently at you..."""
      ...
      /_            |       |            _\
         ~-.        |       |        .-~
           ...
           /___      /\   /\      ___\
                ~-. /  \_/  \ .-~
                   V         V
It looks like this bat is sleeping."""
...
# To see each habitat and exit

animals = [camel, lion, deer, goose, bat, rabbit]
while True:
   habitat = input("Which habitat # do you want to see? ")
   if habitat == 'exit':
      print("See you!")
      break
   else:
